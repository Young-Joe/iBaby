...
/**
 * @author qiaojianfeng on 18/3/24.
 */
...
public class CalendarReminderUtil {
    ...
    private static String CALENDARS_NAME = "iBaby";
    private static String CALENDARS_ACCOUNT_NAME = "iBaby.com";
    private static String CALENDARS_ACCOUNT_TYPE = "com.android.ibaby";
    private static String CALENDARS_DISPLAY_NAME = "iBaby";
